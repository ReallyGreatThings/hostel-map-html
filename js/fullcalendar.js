...
function BasicView(element, calendar, viewName) {
	...
	function buildCellHTML(date) { // date assumed to have stripped time
		...
		html +=
			...
			">" +
			"<div class=\"fc-day-wrapper\">";

		if (showNumbers) {
			html += "<div class='fc-day-number'><span>" + date.date() + "</span></div>";
		}

		html +=
			"<div class='fc-day-content'><span></span>" +
	...
	function renderFix(start, end){
        var startDay = start.format();
        var endDay = end.format();
        console.log(startDay);
        console.log(endDay);
        $('.fc-day').each(function(){
            if($(this).data('date')==startDay){
                $(this).addClass('startFix');
            }
            if($(this).data('date')==endDay){
                $(this).addClass('endFix');
            }
            renderFixBetween(start, end);
           /*if(($(this).data('date')==startDay) || ($(this).data('date')==endDay)){
               $(this).addClass('fix');
           }*/
        });
    }
    ...
    function renderFixBetween(start, end){
        ...
        /*if(endDate.valueOf() > startDate.valueOf()){
            do{
                ...
                startDate.setDate(parseInt(startDate.getDate())+1);
            }while(endDate.valueOf() > startDate.valueOf());
        }*/
    }

    function renderFixClear(){
        $('.fc-day').each(function(){
            $(this).removeClass('startFix').removeClass('endFix').removeClass('dateFix');
        });
    }
	/* External Dragging
	-----------------------------------------------------------------------*/
	...
	function buildSkeleton() {
		...
		if (opt('allDaySlot')) {
			...
			s =
				...
				"</th>" +
				"<td>" +
				"<div class='fc-day-content'><span></span><div style='position:relative'/></div>" +
				"</td>" +
